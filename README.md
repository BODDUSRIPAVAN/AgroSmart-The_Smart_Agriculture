...
<ol>
  ...
  <li>Mannem Pavan Kumar (N181167) - Machine learning engineer</li>
  <li>Mallidi Sandhyarani (N181167) - Problem solver, Content writer</li>
  <li>Pragada Padma Priya (N181167) - Problem solver, Content writer</li>
</ol>
<h2> Description: </h2>
